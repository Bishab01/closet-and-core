...
function AddToCart({ qty, setQty, disabled, onAddToCart, showLoginPrompt, onConfirmLogin, onCancelLogin }) {
  return (
    <>
      ...
      <div className="flex items-start flex-col lg:flex-row lg:items-center gap-3 lg:gap-6">
        <QuantitySelector qty={qty} setQty={setQty} px="3" py="2" textSize="text-base" />
        <button
          onClick={onAddToCart}
          disabled={disabled}
